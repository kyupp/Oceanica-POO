...
public class CommandUsePower extends Command {
    ...
    public void processForServer(ThreadServidor threadServidor) {
        ...
        if (params.length < 2) {
            threadServidor.sendError("Uso: USE_POWER <fighterName>");
            return;
        }
        ...
        List<String> log = fighter.usePower();
        ...
        threadServidor.sendConfirmation("Poder activado. Siguiente ataque será más fuerte.");
    }
}